...
const updateUI = async () => {
  try {
    ...
    if (isAuthenticated) {
      ...
      eachElement(".user-adp", (e) => (e.innerText = user.adp));
      eachElement(".user-adp-folder", (e) => (e.innerText = "directory/"+user.adp));

      eachElement(".user-adp-href", (e) => (e.href = "repfolders/"+user.adp+"/racing.png"));
